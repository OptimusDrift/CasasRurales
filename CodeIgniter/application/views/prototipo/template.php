  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="prototipo" class="nav-link">Inicio</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="vistapropiedad" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ver Propiedades</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="reservarpropiedad" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Reservar una propiedad</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="agregarpropiedad" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agregar una propiedad</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="agregarpaquete" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agregar un paquete</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="verpaquete" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ver paquetes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="verpropiedad" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ver propiedades</p>
                </a>
              </li>
